...
export default function UltimateCardPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[#1A1A2E]">Ultimate Card</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl border p-6">
            <h2 className="font-bold text-[#1A1A2E] mb-4">Routing Mode</h2>
            <RoutingModeSelector selected={mode} onChange={handleModeChange} />
          </div>

          {/* Card Priority */}
          <div className="bg-white rounded-2xl border p-6">
            <h2 className="font-bold text-[#1A1A2E] mb-1">Card Priority</h2>
